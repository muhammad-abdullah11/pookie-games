...
const images = [
  "https://images.unsplash.com/photo-1544015759-1376ce5600d1?q=80&w=200&h=200&auto=format&fit=crop", // Airplane
  "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?q=80&w=200&h=200&auto=format&fit=crop", // Cat
  "https://images.unsplash.com/photo-1506784983877-45594efa4cbe?q=80&w=200&h=200&auto=format&fit=crop", // Box
  "https://images.unsplash.com/photo-1496181133206-80ce9b88a853?q=80&w=200&h=200&auto=format&fit=crop", // Laptop
  "https://images.unsplash.com/photo-1517849845537-4d257902454a?q=80&w=200&h=200&auto=format&fit=crop", // Dog
  "https://images.unsplash.com/photo-1494976388531-d1058494cdd8?q=80&w=200&h=200&auto=format&fit=crop", // Car
  "https://images.unsplash.com/photo-1502082553048-f009c37129b9?q=80&w=200&h=200&auto=format&fit=crop", // Tree
  "https://images.unsplash.com/photo-1490750967868-88aa4486c946?q=80&w=200&h=200&auto=format&fit=crop"  // Flower
];
...
export default function MemoryMatch() {
    ...
    return (
        <main className="min-h-screen flex flex-col items-center justify-center p-6 bg-[#b8c0ff]">
            <h1 className="text-4xl font-bold text-black mb-8">Memory Match</h1>
